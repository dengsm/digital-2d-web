...
export function useAppConfig() {
    ...
    const setCurrentCharacter = (character: ResourceModel | null) => {
        if (character == null) {
            ...
            //     //link: getSrcPath("sentio/characters/free/Chitose/Chitose.png"),
            //     type: RESOURCE_TYPE.CHARACTER,
            // };
            const defaultCharacter: ResourceModel = {
                resource_id: "FREE_Chitose",  // 🔧 改为Chitose保持一致
                name: "Chitose",              // 🔧 改为Chitose保持一致
                link: getSrcPath("sentio/characters/free/Chitose/Chitose.png"),
                type: RESOURCE_TYPE.CHARACTER,
            };
    ...
    const resetAppConfig = () => {
        ...
        const defaultBackground = {
            name: "插画",
            link: "/sentio/backgrounds/static/艺术.jpg", 
